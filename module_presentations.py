...
presentations = [
  #ENL - Begin
  # This presentation apparently must be here. 
  # I put it down with the others and it bugged (title screen went black).
  ("game_start", prsntf_read_only, 0, [
    (ti_on_presentation_load, [
      ...
      (overlay_set_size, "$enl_version_display", pos1),
      (overlay_set_color, "$enl_version_display", 0xFFFFFF),
      
      (create_text_overlay, "$enl_version_check_text", "@Checking for updates...", tf_with_outline),
      (position_set_x, pos1, 0),
      (position_set_y, pos1, 5),
      (overlay_set_position, "$enl_version_check_text", pos1),
      (position_set_x, pos1, 1100),
      (position_set_y, pos1, 1100),
      (overlay_set_size, "$enl_version_check_text", pos1),
      
      (try_begin),
        (eq, "$enl_version_check", 0),
        (send_message_to_url, "str_enl_version_check_url"),  
        (overlay_set_color, "$enl_version_check_text", 0xFFFFFF),
      (else_try),
        (eq, "$enl_version_check", -1),
        (overlay_set_text, "$enl_version_check_text", "@A new version is available"),
        (overlay_set_color, "$enl_version_check_text", 0xE42D0C),
      (else_try),
        (eq, "$enl_version_check", 1),
        (overlay_set_text, "$enl_version_check_text", "@Up to date."),
        (overlay_set_color, "$enl_version_check_text", 0xFFFFFF),
      (else_try),
        (eq, "$enl_version_check", 2),
        (overlay_set_text, "$enl_version_check_text", "@Your version is from the future."),
        (overlay_set_color, "$enl_version_check_text", 0xF9931A),
      (try_end),
    ]),
  ...
  ("game_multiplayer_admin_panel", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_enl_sandiboush"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_enl_a2"),
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_enl_vendetta"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_enl_a3"),
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_enl_frostybattle"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_enl_b1"),
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_enl_reveranvillage"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_enl_b2"),
      (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$enl_announcement_interval_numberbox"),
        (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_announcement_interval, ":value"),
      (else_try),
        (eq, ":object", "$enl_strayhorse_enabled_checkbox"),
        (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_toggle_strayhorses, ":value"),
      (else_try),
        (eq, ":object", "$enl_autokickban_enabled_checkbox"),
        (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_toggle_autokickban, ":value"),
      (else_try),
      #ENL - End
          ...
          (try_begin),
            ...
            (else_try),
              ...
              (try_begin),
                ...
                (create_mesh_overlay, reg0, "mesh_ui_enl_dead"),
                #(overlay_set_color, reg0, ":font_color"),
                #ENL - End
                (position_set_x, pos1, 750),
                (position_set_y, pos1, 750),
      ...
      (try_begin),
        ...
        (try_for_range, ":player_no", 0, ":end_cond"),
          ...
          (try_begin),
            ...
            (store_add, ":sub_cur_x", ":cur_x", 215-50),
            (position_set_x, pos1, ":sub_cur_x"),
            (position_set_y, pos1, ":cur_y"),
            (overlay_set_position, reg0, pos1),
            (position_set_x, pos1, 750),
  ...
  ("multiplayer_escape_menu", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      #ENL - Begin
      (assign, "$enl_printid_button", -1),
      (assign, "$enl_heal_button", -1),
      (assign, "$enl_swap_button", -1),
      (assign, "$enl_teleport_button", -1),
      (assign, "$enl_streaming_button", -1),
      ...
      # (create_button_overlay, "$g_presentation_obj_escape_menu_5", "str_redefine_keys", 0), #ENL - you can access this through options
      ...
      (try_begin),
        ...
        #ENL - Begin
        (create_button_overlay, "$enl_streaming_button", "@Manage streamers", 0),
        (overlay_set_color, "$enl_streaming_button", 0xFFFFFF),
        (try_begin),
          (eq, "$enl_public_mode", 1),
          (create_button_overlay, "$enl_heal_button", "@Heal", 0),
          (overlay_set_color, "$enl_heal_button", 0xFFFFFF),
          (create_button_overlay, "$enl_swap_button", "@Swap", 0),
          (overlay_set_color, "$enl_swap_button", 0xFFFFFF),
      ...
      (try_begin),
        ...
        (player_is_admin, ":my_player_no"),
        (create_button_overlay, "$enl_printid_button", "@Print IDs", 0),
      ...
      #ENL - Begin
      (try_begin),
        (ge, "$enl_heal_button", 0),
        (val_sub, ":cur_y", 32), 
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_size, "$enl_heal_button", pos2),
        (overlay_set_position, "$enl_heal_button", pos1),
      (try_end),
      (try_begin),
        (ge, "$enl_swap_button", 0),
        (val_sub, ":cur_y", 32), 
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_size, "$enl_swap_button", pos2),
        (overlay_set_position, "$enl_swap_button", pos1),
      (try_end),
      (try_begin),
        (ge, "$enl_teleport_button", 0),
        (val_sub, ":cur_y", 32), 
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_size, "$enl_teleport_button", pos2),
        (overlay_set_position, "$enl_teleport_button", pos1),
      (try_end),
      (try_begin),
        (ge, "$enl_streaming_button", 0),
        (val_sub, ":cur_y", 32),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_size, "$enl_streaming_button", pos2),
        (overlay_set_position, "$enl_streaming_button", pos1),
      (try_end),
      (try_begin),
        (ge, "$enl_printid_button", 0),
        (val_sub, ":cur_y", 32),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_size, "$enl_printid_button", pos2),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      #ENL - Begin
      (else_try),
        (eq, ":object", "$enl_printid_button"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 7), #print IDs
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$enl_heal_button"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 8), #heal player
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$enl_swap_button"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 9), #swap player
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$enl_teleport_button"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 10), #teleport player
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$enl_streaming_button"),
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 11), #streaming management
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      #ENL - End
      (try_end),
      ]),
  ...
  ("multiplayer_show_players_list", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (position_set_y, pos1, 600),
      (overlay_set_position, "$enl_players_list_title", pos1),
      
      
      #Adjust container height according to extra controls
      (try_begin),
        (this_or_next|eq, "$g_multiplayer_players_list_action_type", 3),
        (is_between, "$g_multiplayer_players_list_action_type", 5, 10),
        (val_sub, ":container_height", enl_button_height), #Account for "All" button
      (try_end),
      (try_begin),  
        (eq, "$g_multiplayer_players_list_action_type", 10),
        (eq, "$enl_teleport_to_me_or_to_player", 0),
        (val_sub, ":container_height", enl_button_height), #Account for "All" button on "teleport all to me"
      (try_end),
      (try_begin),
        (this_or_next|eq, "$g_multiplayer_players_list_action_type", 4),
        (is_between, "$g_multiplayer_players_list_action_type", 9, 11),
        (val_sub, ":container_height", enl_checkbox_height), #Account for double choice
      (try_end),
      
      (store_add, ":cur_y", ":container_height", 125), #container height plus container y
      ...
      (try_begin),
        (eq, "$g_multiplayer_players_list_action_type", 10),
        (eq, "$enl_teleport_to_me_or_to_player", 1), #do not allow "teleport me to all"
        (assign, ":fail", 1),
      (try_end),
      (try_begin),
        (eq, ":fail", 0),
        (this_or_next|eq, "$g_multiplayer_players_list_action_type", 3),
        (is_between, "$g_multiplayer_players_list_action_type", 5, 11),

        (create_button_overlay, "$enl_button_all", "@All", 0),
        (overlay_set_color, "$enl_button_all", 0xFFFFFF),
        (overlay_set_hilight_color, "$enl_button_all", 0xFF681F), #orange
        (position_set_x, pos1, 285),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$enl_button_all", pos1),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, "$enl_button_all", pos1),
        
        (val_add, ":cur_y", enl_button_height),
      (try_end),
      ...
      #Header
      (try_begin),
        (is_between, "$g_multiplayer_players_list_action_type", 3, 12),
        (create_text_overlay, reg0, "@Player", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (position_set_x, pos1, 285),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (create_text_overlay, reg0, "@Kills", tf_center_justify),
        (overlay_set_color, reg0, 0xFFFFFF),
        (position_set_x, pos1, 505),
        (overlay_set_position, reg0, pos1),
        (overlay_set_size, reg0, pos2),
        
        (create_text_overlay, reg0, "@Deaths", tf_center_justify),
        (overlay_set_color, reg0, 0xFFFFFF),
        ...
        (create_mesh_overlay, reg0, "mesh_white_plane"),
        (position_set_x, pos1, 285),
        (store_sub, ":separator_y", ":cur_y", 2),
        (position_set_y, pos1, ":separator_y"),
        (overlay_set_position, reg0, pos1),
        (position_set_x, pos1, 405*50), #mesh_white_plane is 50x smaller than normal
        (position_set_y, pos1, 2*50),
        (overlay_set_size, reg0, pos1),
      ...
      (try_begin),
        ...
        (overlay_set_size, "$enl_players_list_checkbox_2", pos2),
        
        (overlay_set_val, "$enl_players_list_checkbox_1", 1),
        (overlay_set_val, "$enl_players_list_checkbox_2", 0),
        (try_begin),
          (eq, "$g_multiplayer_players_list_action_type", 4),
          (eq, "$enl_ban_permanently_or_temporarily", 1),
          (overlay_set_val, "$enl_players_list_checkbox_1", 0),
          (overlay_set_val, "$enl_players_list_checkbox_2", 1),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 9),
          (eq, "$enl_swap_team_or_spec", 1),
          (overlay_set_val, "$enl_players_list_checkbox_1", 0),
          (overlay_set_val, "$enl_players_list_checkbox_2", 1),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 10),
          (eq, "$enl_teleport_to_me_or_to_player", 1),
          (overlay_set_val, "$enl_players_list_checkbox_1", 0),
          (overlay_set_val, "$enl_players_list_checkbox_2", 1),
        (try_end),
        
        
        (create_text_overlay, reg0, "@{s3}", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (position_set_x, pos1, 25+285+15),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (overlay_set_size, reg0, pos2),
        
        (create_text_overlay, reg0, "@{s4}", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (position_set_x, pos1, 25+405/2+285+15),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (overlay_set_size, reg0, pos2),
      (try_end),
      ...
      (position_set_x, pos1, 405),
      (position_set_y, pos1, ":container_height"), #ENL - was 500
      ...
      (try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
        ...
        (else_try),
          ...
          (neq, ":my_player", ":player_no"),
          (assign, ":continue", 1),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 11),
          (player_get_team_no, ":team_no", ":player_no"),
      ...
      (try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
        ...
        #ENL - Begin
        (try_begin),
          (eq, "$g_multiplayer_players_list_action_type", 11), #streamer
          
          (create_check_box_overlay, ":overlay_id", "mesh_checkbox_off", "mesh_checkbox_on"),
          (position_set_x, pos2, 650),
          (position_set_y, pos2, 650),
          (overlay_set_size, ":overlay_id", pos2),          
          (position_set_x, pos1, 0),
          (store_add, ":cur_y_checkbox", ":cur_y", 3),
          (position_set_y, pos1, ":cur_y_checkbox"),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
        ...
        (else_try),
          ...
          #ENL - Begin
          (try_begin), 
            (eq, "$enl_ban_permanently_or_temporarily", 1), #perm ban
            (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_temporary_ban, ":player_no"),
          (else_try),
          #ENL - End
        ...
        #ENL - Begin
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 7), #print ID
          (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_print_id, ":player_no"),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 8), #heal
          (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_heal_player, ":player_no"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_multiplayer_show_players_list"),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 9), #swap team or move spec
          (multiplayer_send_3_int_to_server, multiplayer_event_enl_server_common, enl_event_swap_player, ":player_no", "$enl_swap_team_or_spec"),
          (multiplayer_get_my_player, ":my_player"),
          (eq, ":player_no", ":my_player"),
          (eq, "$enl_swap_team_or_spec", 0),
          (presentation_set_duration, 0),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 10), #teleport player
          (multiplayer_get_my_player, ":my_player"),
          (try_begin),
            (eq, "$enl_teleport_to_me_or_to_player", 0),
            (multiplayer_send_3_int_to_server, multiplayer_event_enl_server_common, enl_event_teleport_player, ":player_no", ":my_player"),
          (else_try),
            (multiplayer_send_3_int_to_server, multiplayer_event_enl_server_common, enl_event_teleport_player, ":my_player", ":player_no"),
          (try_end),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 11), #streamers
          (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_toggle_streamer, ":player_no"),
        #ENL - End
        (try_end),
      ...
      #ENL - Begin
      (try_begin),
        (eq, ":object", "$enl_button_all"),
        (try_begin),
          (eq, "$g_multiplayer_players_list_action_type", 3), #admin kick all
          (multiplayer_send_int_to_server, multiplayer_event_enl_server_common, enl_event_kick_all),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 5), #mute all players
          (call_script, "script_enl_mass_mute", 1),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_multiplayer_escape_menu"),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 6), #unmute all players
          (call_script, "script_enl_mass_mute", 0),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_multiplayer_escape_menu"),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 7), #print all IDs
          (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_print_id, multiplayer_max_possible_player_id),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 8), #heal all
          (multiplayer_send_2_int_to_server, multiplayer_event_enl_server_common, enl_event_heal_player, multiplayer_max_possible_player_id),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 9), #swap team or move spec all
          (multiplayer_send_3_int_to_server, multiplayer_event_enl_server_common, enl_event_swap_player, multiplayer_max_possible_player_id, "$enl_swap_team_or_spec"),
          (presentation_set_duration, 0),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 10), #teleport all players
          (multiplayer_get_my_player, ":my_player"),
          (multiplayer_send_3_int_to_server, multiplayer_event_enl_server_common, enl_event_teleport_player, multiplayer_max_possible_player_id, ":my_player"),
        (try_end),
      (try_end),
      (try_begin),
        (this_or_next|eq, ":object", "$enl_players_list_checkbox_1"),
        (eq, ":object", "$enl_players_list_checkbox_2"),
        (store_trigger_param_2, ":value"),
        (store_add, ":other_value", ":value", 1),
        (val_mod, ":other_value", 2),
        
        (try_begin),
          (eq, ":object", "$enl_players_list_checkbox_1"),
          (overlay_set_val, "$enl_players_list_checkbox_2", ":other_value"),
          (try_begin),
            (eq, "$g_multiplayer_players_list_action_type", 4),
            (assign, "$enl_ban_permanently_or_temporarily", ":other_value"),
          (else_try),
            (eq, "$g_multiplayer_players_list_action_type", 9),
            (assign, "$enl_swap_team_or_spec", ":other_value"),
          (else_try),
            (eq, "$g_multiplayer_players_list_action_type", 10),
            (assign, "$enl_teleport_to_me_or_to_player", ":other_value"),
          (try_end),
        (else_try),
          (overlay_set_val, "$enl_players_list_checkbox_1", ":other_value"),
          (try_begin),
            (eq, "$g_multiplayer_players_list_action_type", 4),
            (assign, "$enl_ban_permanently_or_temporarily", ":value"),
          (else_try),
            (eq, "$g_multiplayer_players_list_action_type", 9),
            (assign, "$enl_swap_team_or_spec", ":value"),
          (else_try),
            (eq, "$g_multiplayer_players_list_action_type", 10),
            (assign, "$enl_teleport_to_me_or_to_player", ":value"),
          (try_end),
        (try_end),
    ...
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
      ...
      (try_begin),
        (eq, "$enl_restart_escape_menu", 1),
        (assign, "$enl_restart_escape_menu", 0),
        (is_between, "$g_multiplayer_players_list_action_type", 7, 12),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_multiplayer_escape_menu"),
      (try_end),
      (try_begin),
        (eq, "$enl_restart_players_list", 1),
        (assign, "$enl_restart_players_list", 0),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (try_end),
      #ENL - End
...
##        (gt, ":total_wage", 0),
  ...
  #ENL - Begin
  ("enl_admin_chat", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [
      (set_fixed_point_multiplier, 1000),
      
      (create_text_overlay, reg0, "@Send admin message:", tf_single_line),
      (overlay_set_color, reg0, 0xFF6666),
      ...
      (create_simple_text_box_overlay, "$g_admin_chat_textbox"),
      (position_set_x, pos1, 200),
      (position_set_y, pos1, 500),
      (overlay_set_position, "$g_admin_chat_textbox", pos1),
      (position_set_x, pos2, 600),
      (overlay_set_size, "$g_admin_chat_textbox", pos2),
      (overlay_obtain_focus, "$g_admin_chat_textbox"),
      
      (overlay_set_text, "$g_admin_chat_textbox", "@{s67}"),
      
      (presentation_set_duration, ti_once),
    ]),
    (ti_on_presentation_event_state_change, [
      (store_trigger_param_1, ":object"),
      (eq, ":object", "$g_admin_chat_textbox"),
      (try_begin),
        (key_clicked, key_left_mouse_button),
        (str_store_string, s67, s0),
        # (display_message, "@Saved s67: {s67}", 0xFFFFFF),
      (else_try),
    ...
    (ti_on_presentation_run, [
      ...
      (try_begin),
        (lt, ":cur_time", 20),
        # (str_clear, s0),
        # (overlay_set_text, "$g_admin_chat_textbox", "str_s0"),
        (overlay_set_text, "$g_admin_chat_textbox", "@{s67}"),
        (str_store_string, s0, s67),
      (try_end),
      (try_begin),
