...
#ENL - Begin
enl_admin_chat = (0, 0, 0, [(neg|multiplayer_is_server),(game_key_clicked, gk_inventory_window),],[
    (multiplayer_get_my_player, ":my_player"),
    (player_is_admin, ":my_player"),
    (neg|is_presentation_active, "prsnt_multiplayer_welcome_message"),
    ...
    (neg|is_presentation_active, "prsnt_multiplayer_poll_menu"),
    (neg|is_presentation_active, "prsnt_multiplayer_show_players_list"),
    (neg|is_presentation_active, "prsnt_multiplayer_show_factions_list"),
    (neg|is_presentation_active, "prsnt_multiplayer_show_number_of_bots_list"),
    (neg|is_presentation_active, "prsnt_enl_admin_chat"),
    (start_presentation, "prsnt_enl_admin_chat"),
  ])
...
enl_public_kill_strayhorses = [
  (5, 0, 0, [
    ...
    (try_for_agents, ":cur_agent"),
      ...
      (agent_get_rider, ":rider", ":cur_agent"),
      (lt, ":rider", 0), #Is stray horse
      (try_begin),
        (agent_slot_eq, ":cur_agent", slot_agent_stray_horse_time, 0),
        (store_mission_timer_a, ":time"),
        (agent_set_slot, ":cur_agent", slot_agent_stray_horse_time, ":time"),
      (else_try),
        (agent_get_slot, ":time", ":cur_agent", slot_agent_stray_horse_time),
        (store_mission_timer_a, ":mission_time"),
        (val_sub, ":mission_time", ":time"),
        (ge, ":mission_time", 120),
  ...
  (ti_on_agent_mount, 0, 0, [
    ...
    (agent_set_slot, ":horse", slot_agent_stray_horse_time, 0),
  ]),
]


  
enl_public_autokickban = [
  ...
  (ti_on_agent_killed_or_wounded, 0, 0, [
    ...
    (try_begin), #killing teammate
      ...
      (else_try),
        #not kick or ban
        (player_set_slot, ":killer_agent_player_id", slot_player_teamkills, ":teamkills"),
        (call_script, "script_enl_sync_teamkiller_to_all_admins", ":killer_agent_player_id", ":teamkills"),
      (try_end),
    (try_end),
  ]),
    ...
    [
      ...
      (ti_escape_pressed, 0, 0, [],
       [
         (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),
         (neg|is_presentation_active, "prsnt_multiplayer_stats_chart_deathmatch"),
         (neg|is_presentation_active, "prsnt_enl_admin_chat"), #ENL
    ...
    [
      ...
      (ti_on_multiplayer_mission_end, 0, 0, [],
       [
         ...
         (str_store_string, s0, "@[EVENT]: Map ended. Score is {reg0} - {reg1} ({reg2} {reg3?draws:draw})"),
         (server_add_message_to_log, "str_s0"),
         #ENL - End
         ]),
      ...
      (1, 0, 3, [(multiplayer_is_server),
       ...
       [
         ...
         (try_begin),
           ...
           (assign, reg2, "$g_multiplayer_enl_draw_count"),
           (store_sub, reg3, reg2, 1),
           (str_store_string, s0, "@[EVENT]: Round start. Score at {reg0} - {reg1} ({reg2} {reg3?draws:draw})"),
           (server_add_message_to_log, "str_s0"),
         (try_end),
         #ENL - End
         #auto team balance control at the end of round         
